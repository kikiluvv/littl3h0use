...
const storage = multer.diskStorage({
    destination: (req, file, cb) => {
        cb(null, 'public/assetts/shop'); // Specify the destination folder for uploaded files
    },
...
app.post('/authenticate', (req, res) => {
    ...
    // Perform simple username/password check
    if (
...
app.post('/dashboard/add-item', requireAuth, upload.fields([
    ...
    console.log('req.files:', req.files); // Add this line to log the uploaded files
